...
---------------------------------------------------------------------------------------
g_uiAddins = {};
table.insert(g_uiAddins, ContextPtr:LoadNewContext([[SeparateGreatPeopleCounters]]));
table.insert(g_uiAddins, ContextPtr:LoadNewContext([[SerialEventUnitCreatedGood]]));

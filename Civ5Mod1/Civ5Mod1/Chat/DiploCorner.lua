...
function OnChat( fromPlayer, toPlayer, text, eTargetType )
    ...
    controlTable.String:SetColor( GameInfo.PlayerColors[Players[fromPlayer]:GetPlayerColor()].ID );--GameInfo.PlayerColors[Players[fromPlayer].PlayerColor].Name );
	-- fromPlayer: oneself = 0
	--India:  Players[fromPlayer]:GetPlayerColor() = 72, Korea: 86
	--GameInfo.PlayerColors[Players[fromPlayer]:GetPlayerColor()].ID, Aztec: 65, India: 72

	--not working: GameInfo.PlayerColors[Players[fromPlayer]:GetPlayerColor()]:GetName(), GameInfo.PlayerColors[Players[fromPlayer]:GetPlayerColor()].Name, Players[fromPlayer]:GetPlayerColor():GetName(), Players[fromPlayer]:GetPlayerColor().Name
